...
const SelfDefense = () => {
  return (
    <div className="self-defense-container">
      <h1>8 Self-Defense Moves Every Woman Needs to Know</h1>
      <p>
        Walking home alone and feeling uneasy? Getting a weird vibe from a stranger on the bus? Many of us have been there.
        Here are eight self-defense moves to help you feel empowered and protected in any situation.
      </p>
      
      <h2>Focus on the Vulnerable Areas</h2>
      <p>
        Focus on your attacker's vulnerable areas: eyes, nose, throat, and groin. Avoid the chest and knees.
        Use all of your force and aggression, and be loud to create attention.
      </p>
      ...
      <div className="moves-section">
        ...
        <img src='/images/sd/selfdefense2.gif' alt = 'hammer strike' />
        <h4>To Perform</h4>
        <ol>
          <li>Hold your key ring in a tight fist, with keys extending from the side of your hand.</li>
        ...
        <ol>
          ...
          <li>Lift your dominant leg and kick forcefully to the attacker’s groin area.</li>
        </ol>
        ...
        <h4>To Perform</h4>
        <ol>
          <li>With your dominant hand, flex your wrist and aim for the nose or under the chin.</li>
          <li>Recoil your strike quickly to stagger the attacker.</li>
        </ol>
        ...
        <h4>To Perform from the back</h4>
        <ol>
        ...
        <h4>To Perform</h4>
        <ol>
          <li>Bend forward from the waist. This shifts your weight forward, making it more difficult for your attacker to pick you up. 
              It also gives you a better angle to throw elbows from side to side to the attacker’s face.</li>
        ...
        <h4>To Perform</h4>
        <ol>
          <li>First reaction should be to stop your attacker’s arms from going higher into a headlock. Shift your hips to one side. 
              This gives an opening for strikes to the groin with open-handed slaps.</li>
          <li>Bring your hand back up to your arms and raise your opposite elbow to turn into the wrap. 
        ...
        <ol>
          ...
          <li>With your hand that’s furthest away, strike the groin with open-handed slaps until 
              you have enough mobility to turn your head all the way out to disengage.</li>
        </ol>
      </div>

      <h2>How to Stay Safe if You Aren't Physically Able to Protect Yourself</h2>
      <p>
        If self-defense isn’t an option, stay in well-lit public areas, carry self-defense tools, and call emergency services if needed.
      </p>
      ...
      <div className="protection-alternatives">
        ...
        <ul>
          ...
          <li>Get training on how to use any self-defense tools effectively.</li>
        </ul>
      </div>
    </div>
  );
